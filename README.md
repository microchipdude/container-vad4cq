...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-vad4cq.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-vad4cq.containers.anotherwebservice.com/
...
```
git clone git@github.com:microchipdude/container-vad4cq.git
cd container-vad4cq
```
...
```
docker attach container-vad4cq
```
